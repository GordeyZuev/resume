...
% Sections formatting
\titleformat{\section}{
  \vspace{-4pt}\textsc\raggedright\large
...
\begin{center}
    \textbf{\Huge \textsc Gordey Zuev} \\ \vspace{1pt}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Higher School of Economics, }{September 2023 -- Present}
...
\section{Honors and Awards}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{The best teaching Assistant of the semester} $|$ \emph{Python, Flask, React, PostgreSQL, Docker}}{June 2020 -- Present}
          \resumeItemListStart
            \resumeItem{Developed a full-stack web application using with Flask serving a REST API with React as the frontend}
            \resumeItem{Implemented GitHub OAuth to get data from user’s repositories}
            \resumeItem{Visualized GitHub data to show collaboration}
