...
% 1) Кодировка для кириллицы
\usepackage[T2A]{fontenc}
\usepackage[utf8]{inputenc}
\usepackage[russian,english]{babel}

% 2) Шрифт с полноценной поддержкой кириллицы и bold
%\usepackage{cfr-lm}  % Latin Modern + Cyrillic
...
\section{Краткая информация}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     {\textbf{Junior Python backend-разработчик} с академическим бэкграундом в прикладной математике (\textbf{НИУ ВШЭ, 3 курс}). Люблю оптимизировать все вокруг и создавать эффективные backend-решения. Трехлетний \textbf{преподавательский опыт} (860+ студентов) развил навыки анализа кода и объяснения сложных концепций. Интересуюсь архитектурой распределенных систем как в программировании, так и в городском планировании.
     }
    }}
 \end{itemize}
...
\section{Опыт работы}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {\textbf{Лицей НИУ ВШЭ}: «Программирование на Python» / «Алгоритмы»}{Сен 23' -- Наст. время}
      \resumeItemListStart
...
%-----------PROJECT 1-----------
    ...
    {\textbf{Автоматическая бронь билетов} $|$ \emph{Архитектура: Python, FastAPI, PostgreSQL, Redis}}{Окт 24` -- Май 25`}
    \resumeItemListStart
        \resumeItem{Спроектировал \textbf{схему БД \textit{PostgreSQL}} для системы бронирования с оптимизированными индексами.}
...
%-----------PROJECT 2-----------
 ...
 %-----------PROJECT 3-----------
    \resumeProjectHeading
        {\textbf{Обучение модели для прогнозирование риска отчисления} $|$ \emph{Python, ML}}{Ноя 24` -- Наст. время}
        \resumeItemListStart
            ...
            \resumeItem{\underline{\textbf{Итоги}}: Полученные данные помогли создать систему раннего предупреждения студентов, снизив уровень отчислений.}
        \resumeItemListEnd
