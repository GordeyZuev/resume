...
\begin{flushleft}
  \myname{Gordey} %name
  \myname{Zuev} %surname
  \myjobtitle{HSE Student} %designation
...
Russia\\
\uppersubtopic{phone}
+7 929 628 43 38\\ % give your contact no here
\uppersubtopic{email}
gordey.zuev@gmail.com\\ % mail adress here
\uppersubtopic{Date/Place of Birth}
02 April 2004\\ % Date of birth and place
Moscow,\\
Russia\\
...
\begin{flushleft}
    ...
    \lsubtopic{School №1282 (English School)}{Moscow, Russia} 
    
       Sep 2012 - May 2019
    \begin{itemize}
        \item GPA: 5.0 (Russian system)
    \end{itemize}

    \lsubtopic{HSE Lyceum}{Moscow, Russia} 
    
       Sep 2019 - June 2022
    \begin{itemize}
        \item GPA: 4.87 (Russian system)
        \item Completed School System
    \end{itemize}
  
    \lsubtopic{HSE - Faculty of Computer Science}{Moscow, Russia}
